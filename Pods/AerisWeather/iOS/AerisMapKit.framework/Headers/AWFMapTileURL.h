...
- (NSURL *)tileURLForX:(NSInteger)x y:(NSInteger)y zoomLevel:(NSUInteger)zoomLevel scaledForScreen:(BOOL)scaledForScreen;
...
- (NSURL *)tileURLForX:(NSInteger)x y:(NSInteger)y zoomLevel:(NSUInteger)zoomLevel offset:(nullable NSString *)offset scaledForScreen:(BOOL)scaledForScreen;
...
- (NSURL *)tileURLForBounds:(AWFMapCoordinateBounds *)bounds size:(CGSize)size offset:(nullable NSString *)offset scaledForScreen:(BOOL)scaledForScreen;
